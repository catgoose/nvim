...
g("Hexokinase_ftEnabled", { "css", "scss", "sass", "html", "javascript", "toml", "i3config", "roficonfig" })
g("Hexokinase_ftOptInPatterns", {
	i3config = "full_hex",
	roficonfig = "full_hex",
	css = "full_hex,rgb,rgba,hsl,hsla,colour_names",
	scss = "full_hex,rgb,rgba,hsl,hsla,colour_names",
	sass = "full_hex,rgb,rgba,hsl,hsla,colour_names",
