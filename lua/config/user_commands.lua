...
c("WinOnly", function() f.win_only() end)
c("WinOnlyFocusLeft", function()
  f.win_only(function() vim.cmd("vsplit") end)
end)
...
c("TagStackDown", function() f.tagstack_navigate({ direction = "down" }) end)
c("TagStackUp", function() f.tagstack_navigate({ direction = "up" }) end)
c("ToggleCmdHeight", f.toggle_cmdheight)
c("ToggleTermFish", function() f.toggle_term_cmd({ count = 4, cmd = "fish" }) end)
c("ToggleTermLazyDocker", function() f.toggle_term_cmd({ count = 2, cmd = "lazydocker" }) end)
c("ToggleTermLazyGit", function() f.toggle_term_cmd({ count = 3, cmd = "lazygit" }) end)
c("ToggleTermWeeChat", function() f.toggle_term_cmd({ count = 5, cmd = "weechat" }) end)
c("ToggleTermPowershell", function() f.toggle_term_cmd({ count = 10, cmd = "pwsh" }) end)
c(
  "ToggleTermRepl",
  function()
...
c("ToggleTermSpotify", function() f.toggle_term_cmd({ count = 1, cmd = "spotify_player" }) end)
...
c("TerminalSendCmd", function() f.terminal_send_cmd("ls") end)
c("TabNext", function() f.tabnavigate({ navto = "next" }) end)
c("TabPrevious", function() f.tabnavigate({ navto = "prev" }) end)
c("DisableLSPFormatting", function() f.lsp_formatting({ enable = false }) end)
c("EnableLSPFormatting", function() f.lsp_formatting({ enable = true }) end)
c("PersistenceLoad", function() require("persistence").load() end)
